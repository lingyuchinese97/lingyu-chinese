    ...
    <>
      ...
      >
        ...
        <p className="mt-1.5 text-[15px] text-text-2 md:text-[17px]">
          Học từng bước: nghe, nhận diện và ghép âm tiếng Trung.
        </p>
      </section>
          ...
          return (
            <li key={l.id}>
              ...
              >
                ...
                <ProgressBar value={done} max={l.sections.length} label={`Tiến độ Bài ${l.number}`} />
                <span className="flex items-center justify-between text-sm text-text-2">
                  <span className="inline-flex items-center gap-1.5">
                    ...
                    Đã làm {done}/{l.sections.length} phần
                  </span>
                  <span className="inline-flex items-center gap-1 font-semibold text-blue-600">
                    {done ? "Tiếp tục" : "Bắt đầu"}
