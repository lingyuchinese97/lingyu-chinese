import { BookOpen, GraduationCap, House, Settings, ShieldCheck } from "lucide-react";
import { GrammarIcon, RadicalIcon, ReviewIcon } from "./icons";

export type NavKey = "home" | "vocabulary" | "grammar" | "radicals" | "lessons" | "review" | "settings" | "admin";
...
/** Thanh tab dưới đáy (điện thoại): 5 mục; Bộ thủ, Cài đặt, Quản trị nằm trong menu ☰. */
...
export function shellState(pathname: string): ShellState {
  ...
  const focus =
    ((first === "vocabulary" || first === "grammar") && (seg[1] === "new" || seg[2] === "edit")) ||
